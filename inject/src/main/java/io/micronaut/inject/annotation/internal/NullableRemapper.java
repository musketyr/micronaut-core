...
/**
 * A remapper that remaps new nullable/non-null annotations to javax.annotation which are represented internally.
 *
 * @author graemerocher
 * @since 1.3.8
 */
@Internal
public final class NullableRemapper implements AnnotationRemapper {
